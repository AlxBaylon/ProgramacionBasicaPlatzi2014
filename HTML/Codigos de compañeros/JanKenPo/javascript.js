...
{    var opcionMaquina=patito(0,4);
    alert(opciones[v]+" VS "+opciones[opcionMaquina])
    resultado(v,opcionMaquina); }

//Forma mas corta de Comprobar Resultados
function resultado(n1,n2)
{    if(n1==n2)
    { titulo2.textContent="Empate" }
    else
    {    if (  (n1==piedra &&n2==lagarto)||(n1==piedra &&n2==tijera)
        ...
        {titulo2.textContent="Ganaste"}
        else 
        {titulo2.textContent="Perdiste"} }; 
}
